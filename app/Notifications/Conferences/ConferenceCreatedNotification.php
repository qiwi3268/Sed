...
final class ConferenceCreatedNotification extends Notification implements LoggedNotification, ShouldQueue
{
    use Queueable;
    ...
    {
        return MailNotificationFactory::getCreatedMailMessage($this->conference);
    }
}
