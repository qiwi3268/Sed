...
final class ConferenceBeforeStartingNotification extends Notification implements LoggedNotification, ShouldQueue
{
    use Queueable;
    ...
    {
        return MailNotificationFactory::getBeforeStartingMailMessage($this->conference);
    }
}
